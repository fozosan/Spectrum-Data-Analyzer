...
class TrendlineForm(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.data_model_combo.addItems(["Linear"])
        ...
        self.lit_model_combo.addItems(["Linear"])
    ...
    def _emit_literature(self) -> None:
        ...
        try:
            coeff1 = float(self.lit_coeff1.text())
            coeff2 = float(self.lit_coeff2.text())
        except ValueError:
            return
        payload = {"model": model, "coeffs": (coeff1, coeff2)}
